...
```bash
git remote add encore encore://video-link-generator-xcp2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/video-link-generator-xcp2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/video-link-generator-xcp2/settings/integrations/github)
